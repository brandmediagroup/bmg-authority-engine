...
{/* BMG Branding */}
      <div style={{ textAlign:'center', padding:'12px 0 20px' }}>
        <div style={{ display:'inline-flex', alignItems:'center', gap:10, background:'#F8FAFC', border:'1px solid #E2E8F0', borderRadius:10, padding:'10px 24px' }}>
          <span style={{ fontSize:16 }}>⚡</span>
          <span style={{ fontSize:10, letterSpacing:2, color:'#64748B', fontWeight:800 }}>GENERATED BY BMG AUTHORITY ENGINE™</span>
          <span style={{ color:'#CBD5E1', fontSize:10 }}>|</span>
          <a href="https://brandmediagroup.co" target="_blank" rel="noreferrer"
            style={{ fontSize:10, color:'#2563EB', fontWeight:700, letterSpacing:1, textDecoration:'none' }}>
            BRANDMEDIAGROUP.CO
          </a>
        </div>
      </div>      <div style={{ display:'flex', gap:12, marginBottom:32, flexWrap:'wrap' }}>
